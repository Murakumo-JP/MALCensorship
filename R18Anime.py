...
while True:
    ...
    request = requests.get(f"https://myanimelist.net/anime/genre/12/Hentai?page={page}", headers=headers)
...
print("Scraping completed. New entries added to R18Anime.css")